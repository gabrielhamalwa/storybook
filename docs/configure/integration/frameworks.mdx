...
| Vite    | React, Vue 3, Web Components, HTML, Svelte, SvelteKit, Qwik, Solid, Symfony (preview) |
...
| `symfony`        | Configures the Symfony PHP backend lifecycle<br />`framework: { name: '@storybook/symfony-vite', options: { symfony: { server: 'php' } } }`                                                                                                                  | Symfony   |
