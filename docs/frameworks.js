module.exports = {
  ...
  communityFrameworks: ['ember', 'html', 'svelte', 'preact', 'qwik', 'solid', 'symfony'],
  featureGroups: [
    {
      name: 'Essentials',
      features: [
        ...
        {
          name: 'Controls',
          supported: ['react', 'vue', 'angular', 'web-components', 'ember', 'symfony'],
    ...
    },
    {
      ...
      features: [
        ...
        {
          name: 'Inline stories',
          supported: ['react', 'vue', 'web-components', 'html', 'svelte', 'angular', 'symfony'],
        },
      ],
    },
  ],
